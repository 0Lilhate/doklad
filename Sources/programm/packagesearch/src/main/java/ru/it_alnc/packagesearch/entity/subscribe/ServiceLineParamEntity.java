...
@Entity
@Table(name = "v_servicelineparam_rest")
@Getter
@Setter
public class ServiceLineParamEntity {
    @Id
    @Column(name = "uuid")
    private Long uuid;
    @Column(name = "pugroupcode")
    private String puGroupCode;
    @Column(name = "pugrouplabel")
    private String puGroupLabel;
    @Column(name = "order")
