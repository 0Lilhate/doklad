...
То, что должно вернуть агент на шаге 6 (Impact area, dev-track). Используется на live demo как эталон.
...
Технический AS-IS, что агент строит на шаге 7 (dev-track). Технический TO-BE в текущей demo не выделен отдельным шагом — он растворён в плане реализации шага 8. Шаблон «После изменения» ниже — generic-резерв для случаев, когда команда захочет сделать TO-BE-sequence отдельным артефактом.

### Текущий flow (шаг 7 — AS-IS)
...
### После изменения (опционально, как часть плана шага 8)
