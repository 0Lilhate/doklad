...
Run the `brag-spotter` subagent with `scope: week`. It scans git log, recent work-notes, 1-1 quotes, and incident completions, then deduplicates against `perf/Brag Doc.md`.
