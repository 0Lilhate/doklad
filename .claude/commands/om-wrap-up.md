...
- **`brag-spotter`** — `scope: session`. Find uncaptured wins from this session.
- **`quality-reviewer`** — `session: true`. Verify quality bar of notes created/modified this session.
